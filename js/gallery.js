...
$(document).ready(function () {
  ...
  getImagesFromCloudinary().then((images) => {
    images.forEach((item, index) => {
      $(".gallery").append(
        `<a class="image-popup-no-margins" href="${item}"><div class='mask'><figure class="gallery-image"><img src="${modifyImageUrl(
          item
        )}" alt="image"></figure></div></a>`
      );
    });
...
function resetCoverHeight() {
  $(".gallery-fixed-container").css({
    top: $(".navigation").outerHeight() + "px",
  });
  $(".gallery-description-container").css({
    top: $(".navigation").outerHeight() + "px",
  });
}
